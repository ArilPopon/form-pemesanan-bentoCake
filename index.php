...
<body>
    <div class=" container border">
        ...
        <img src="assets/logo.jpg" alt="Logo Restoran">
            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    <select id="lokasi" name="lokasi">
						...
						foreach ($daftar_jangkauan as $daerah) {
	...
	if (isset($_POST['Pesan'])) {
		...
		$ongkir = 0; // Default nilai ongkir awal

		// Mendapatkan nilai lokasi dari data pemesanan
		$lokasi = $dataPesanan['lokasi'];

		// Melakukan kontrol percabangan untuk menghitung ongkos kirim sesuai lokasi
		if (
			$lokasi == "Tangerang"
		) {
			$ongkir = 5000; // Ongkos kirim untuk Tangerang
		} elseif ($lokasi == "Bogor") {
			$ongkir = 10000; // Ongkos kirim untuk Bogor
		} elseif ($lokasi == "Jakarta" || $lokasi == "Depok" || $lokasi == "Bekasi") {
			// Gratis ongkos kirim untuk Jakarta, Depok, dan Bekasi
			$ongkir = 0;
		}
